...
def plot_original_data(x, y):
    ...
    fig1.savefig('gradient_descent-1.eps', format='eps', dpi=1000, bbox_inches = 'tight', pad_inches = 0)
    fig1.savefig('gradient_descent-1.pdf', format='pdf', dpi=1000, bbox_inches = 'tight', pad_inches = 0)
    fig1.savefig('gradient_descent-1.png', dpi=1000, bbox_inches = 'tight', pad_inches = 0)
...
def train(spendings, sales, w, b, alpha, epochs):
    ...
    for e in range(epochs):
        ...
        if (e == 0) or (e < 3000 and e % 400 == 0) or (e % 3000 == 0):
            ...
            fig1.savefig('gradient_descent-' + str(image_counter) + '.png', dpi=1000, bbox_inches = 'tight', pad_inches = 0)
            image_counter += 1
    return w, b
...
n, x1, x2, x3, y = np.loadtxt("Advertising.csv", delimiter=",", skiprows=1, unpack=True)
plot_original_data(x2, y)

w, b = train(x2, y, 0.0, 0.0, 0.001, 15000)
